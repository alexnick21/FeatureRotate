...
class GeometryRotator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeometryRotator_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Geometry rotator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeometryRotator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/geometry_rotator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Поворот геометрии'),
            callback=self.run,
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            self.dlg = GeometryRotatorDialog()
            # Валидируем ввод. А то, кабы чего не вышло.
            angle_validator = QgsDoubleValidator(-360.0,360.0,5,None)
            self.dlg.angleLineEdit.setValidator(angle_validator)
